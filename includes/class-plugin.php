...
class Mst_Plugin_Template {

	/**
	 * The single instance of Mst_Plugin_Template.
	 * @var 	object
	 * @access  private
	 * @since 	1.0.0
	 */
	...
	/**
	 * Main Mst_Plugin_Template Instance
	 *
	 * Ensures only one instance of Mst_Plugin_Template is loaded or can be loaded.
	 *
	 * @since 1.0.0
	 * @static
	 * @see Mst_Plugin_Template()
	 * @return Main Mst_Plugin_Template instance
	 */
